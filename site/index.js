...
import { general, components, layouts } from './pages';
import Layout from './components/Layout';

const history = window.history;

const mappedPages = mapPages(general, components, layouts);
...
class Site extends React.Component {
  ...
  render() {
    ...
    return (
      <Layout
        menu={{ general, components, layouts }}
...
function mapPages(general, components, layouts) {
  let map = {};
  [...general, ...components, ...layouts].forEach(page => {
